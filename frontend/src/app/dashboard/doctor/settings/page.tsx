  ...
  return (
    <div className="space-y-6">
      <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
        ...
        <p className="mt-3 text-slate-500">These controls are now linked to the doctor settings API so you can toggle the monitoring behavior from the UI.</p>
      </section>

      <div className="grid gap-6 xl:grid-cols-2">
        {[
          ["liveTelemetry", "Live telemetry streaming", "Stream real-time vitals and device packets into the doctor workspace."],
          ["aiAlerts", "AI alerts", "Enable predictive alerting and anomaly recommendations."],
          ["autoRefresh", "Auto refresh", "Refresh dashboard cards and metrics automatically."],
          ["notifications", "Notifications", "Show chat, alert, and escalation notifications in the UI."],
          ["darkMode", "Dark mode", "Use the darker clinical theme for the dashboard."],
        ].map(([key, title, text]) => (
